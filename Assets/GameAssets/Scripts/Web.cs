...
public class Web : MonoBehaviour
{
    ...
    public IEnumerator SubmitScore(string playerName, int playerScore)
    {
        ...
        //using (UnityWebRequest www = UnityWebRequest.Post("https://duriangames.tk/MoleGameSubmitScoreLimitedAS.php", form))
        //using (UnityWebRequest www = UnityWebRequest.Post("http://localhost:3004/molegame", form))
        using (UnityWebRequest www = UnityWebRequest.Post("https://whackamole-be.adaptable.app/molegame", form))
        {
