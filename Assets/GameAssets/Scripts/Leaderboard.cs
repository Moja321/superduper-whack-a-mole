...
public class Leaderboard : MonoBehaviour
{
    ...
    {
        StartCoroutine(Main.Instance.Web.GetLeaderboard("https://whackamole-be.adaptable.app/molegame"));
        //StartCoroutine(Main.Instance.Web.GetLeaderboard("http://localhost:3004/molegame"));
        //StartCoroutine(Main.Instance.Web.GetLeaderboard("https://duriangames.tk/MoleGameGetScoreFinalAS.php"));
